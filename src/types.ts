...
export type GetContent<T> = "content" extends keyof T
  ? ResponseType extends keyof T["content"] ? T["content"][ResponseType]
  : never
  : never;
...
export type TwitterParams<T> = "parameters" extends keyof T
  ? "query" extends keyof T["parameters"] ? T["parameters"]["query"]
  : never
  : never;

export type TwitterPath<T> = "parameters" extends keyof T
  ? "path" extends keyof T["parameters"] ? T["parameters"]["path"]
  : never
  : never;
...
export * from "./gen/openapi-types.ts";
